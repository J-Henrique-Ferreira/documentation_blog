<header class="flex justify-between bg-white border-b border-gray-200 py-2 pr-4 fixed top-0 w-full z-20">
    <div class="w-full h-full px-4 flex items-center justify-between gap-4">
        ...
        @if(isset($displayFilter))
            <div class="flex-1 flex max-w-3xl gap-2">
                ...
                @if(isset($categoriesList))
                    <select
                        class="px-4 py-2 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 pr-5 w-[300px]">
